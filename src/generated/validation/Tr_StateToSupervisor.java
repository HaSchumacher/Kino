...
public class Tr_StateToSupervisor
{
   //30 ===== GENERATED:      Attribute Section ======
   private static Tr_StateToSupervisor theInstance = new Tr_StateToSupervisor();
   private Relation<Transition,State> elements;
   //40 ===== Editable : Your Attribute Section ======
   
   //50 ===== GENERATED:      Constructor ============
   private Tr_StateToSupervisor(){
      this.elements = new Relation<>();
   }
   //60 ===== Editable : Your Constructors ===========
   
   //70 ===== GENERATED:      Feature Access =========
   public static Tr_StateToSupervisor getInstance(){return theInstance;}
   public State getTo(Transition owner){
