...
public class ControllerTestPublics implements Observer {
	...
	public ControllerTestPublics(CinemaService m, View v, Pipe p) throws NoSuchAlgorithmException, NoSuchPaddingException, PersistenceException {
		this.model = m;
		this.view = v;
		this.myPipe = p;
	...
	public void logout() throws PersistenceException, InterruptedException {
